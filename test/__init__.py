...
@dataclass
class FilePaths:
    stats: str = Path(__file__).resolve().parent / "data" / "stats-10000.csv"
    centroids: str = Path(__file__).resolve().parent / "data" / "centroids-20.csv"
    clusters: str = Path(__file__).resolve().parent / "data" / "clusters-20.csv"
