...
def main(players: pd.DataFrame, k: int,
    ...
    for i, (split, skills) in enumerate(splits.items()):
        ...
        stats[stats == 0] = 1
        centroids = fit_kmeans(stats, k, w=weights, verbose=verbose)
...
if __name__ == "__main__":
    ...
    clusterids_df, centroids_dict = main(players_df, k=args.nclusters, splits=load_splits(), verbose=args.verbose)
